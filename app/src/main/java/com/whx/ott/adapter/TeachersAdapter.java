 ...
 */
public class TeachersAdapter extends BaseRecyclerViewAdapter<TeachersBean> {

    private Context mContext;

    public TeachersAdapter(Context mContext) {
    ...
    protected void bindData(BaseRecyclerViewHolder holder, int position) {
        ((MyViewHolder)holder).textView.setText(getItemData(position).getTeacher_name());
    }
