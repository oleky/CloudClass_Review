 ...
 */
public class TermsAdapter extends BaseRecyclerViewAdapter<TermsBean> {

    private Context mContext;

    public TermsAdapter(Context mContext) {
    ...
    protected void bindData(BaseRecyclerViewHolder holder, int position) {
        ((MyViewHolder)holder).textView.setText(getItemData(position).getTerm_name());
    }
