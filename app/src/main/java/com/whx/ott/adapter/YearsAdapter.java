 ...
 */
public class YearsAdapter extends BaseRecyclerViewAdapter<YearsBean> {

    private Context mContext;

    public YearsAdapter(Context mContext) {
    ...
    protected void bindData(BaseRecyclerViewHolder holder, int position) {
        ((MyViewHolder)holder).textView.setText(getItemData(position).getYear_name());
