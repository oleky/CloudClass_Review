...
public class NewMineTitleAdapter extends RecyclerView.Adapter<NewMineTitleAdapter.ViewHolder> {
    private Context context;
    private List<String> names;
    private OnTextViewColorChangeListener listener;

    public NewMineTitleAdapter(Context context, List<String> names) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_title_mine, parent, false);
