...
import com.whx.ott.adapter.TownFeatureResultAdapter;
import com.whx.ott.adapter.TownSoulplateAdapter;
 ...
 */
public class TownFeatureActivity extends Activity implements View.OnFocusChangeListener
        ,RecyclerViewTV.OnItemListener,TeseClassView{

    public static final String YEARID       = "year_id";
    public static final String TOWN_SOULPLATEID       = "soulplate_id";
    ...
    private int end_item    =200;//分页结束 共100条
    ...
    private TownFeatureResultAdapter resultAdapter;
    JichuResult jichu;
    MainUpView                  mainUpView1;
    RecyclerViewBridge          mRecyclerViewBridge;

    private List<YearsBean>     yearList    = new ArrayList<>();
    private List<Soulplates>     souplateList    = new ArrayList<>();
    ...
    private List<SoulcoursesBean>   courseList  = new ArrayList<>();
    ...
    private SoulcoursesBean mCoursesBean;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_feature_town);
...
//初始化显示
        ...
        souplateList = manager.getSoulplateList();
    ...
    private void initRecycler() {
        ...
        LinearLayoutManagerTV linearLayoutManager1 = new LinearLayoutManagerTV(TownFeatureActivity.this);
        LinearLayoutManagerTV linearLayoutManager2 = new LinearLayoutManagerTV(TownFeatureActivity.this);
        LinearLayoutManagerTV linearLayoutManager3 = new LinearLayoutManagerTV(TownFeatureActivity.this);
        LinearLayoutManagerTV linearLayoutManager4 = new LinearLayoutManagerTV(TownFeatureActivity.this);
        LinearLayoutManagerTV linearLayoutManager5 = new LinearLayoutManagerTV(TownFeatureActivity.this);
        GridLayoutManagerTV gridLayoutManager = new GridLayoutManagerTV(TownFeatureActivity.this, 2);
...
//
    ...
    private void initTerm() {
        soulplateAdapter = new TownSoulplateAdapter(this);
        soulplateAdapter.setData(souplateList);
        terms_gp.setAdapter(soulplateAdapter);
        terms_gp.setFocusable(false);
        soulplateAdapter.notifyDataSetChanged();
...
//                itemView.setBackgroundResource(R.drawable.item_rectangle);
                ...
                int id = souplateList.get(position).getId();
                String gradeids = souplateList.get(position).getGrade_ids();
                /**
                 * term栏与grade栏联动
                 * */
...
//                itemView.setBackgroundResource(R.drawable.item_rectangle);
    ...
    private void updateUI(List<Map<String,String>> mList,int start,int end) {
        ...
        map.put(TOWN_SOULPLATEID, mList.get(1).get(TOWN_SOULPLATEID));
...
//        mRecyclerViewBridge.setFocusView(v, oldView, 1.05f);
    ...
    private void updateGridView() {
        ...
        resultAdapter = new TownFeatureResultAdapter(TownFeatureActivity.this);
        ...
        results_gp.setOnItemClickListener(new RecyclerViewTV.OnItemClickListener() {
            ...
            public void onItemClick(RecyclerViewTV parent, View itemView, int position) {
                //
                SoulcoursesBean bean = courseList.get(position);
                mCoursesBean = bean;
                String file_name = bean.getFile_name();
                if (TextUtils.isEmpty(file_name)) {
                    //判断file_name 是否为空，如果为空无此视频
                    Toast.makeText(TownFeatureActivity.this, "资源不存在", Toast.LENGTH_SHORT).show();
                } else {
                    //跳转播放视频
                    if (file_name.contains(".")) {
                        ...
                        Intent intent = new Intent(TownFeatureActivity.this, WkWebActivity.class);
                        ...
                        TownFeatureActivity.this.startActivity(intent);
                    }
                }
        ...
        results_gp.setPagingableListener(new RecyclerViewTV.PagingableListener() {
            ...
            public void onLoadMoreItems() {
                if (courseList != null && courseList.size() > 0) {
                    if (!isLoading) {
                        CustomProgressDialog.show(TownFeatureActivity.this, "加载中···", false, null);
    ...
    @Override
    public void getDate(List<SoulcoursesBean> cList) {
        if (cList != null ) {
            courseList.clear();
    ...
    public void geturl(String url) {
        Intent intent = new Intent(TownFeatureActivity.this, CCPlayerActivity.class);
        Bundle bundle = new Bundle();
        String videoPath = !TextUtils.isEmpty(url) ? url : "";
        bundle.putSerializable("soulcoursesBean", mCoursesBean);
        intent.putExtra("videoPath", videoPath);
        intent.putExtra("model_id",2);
        intent.putExtra("type_id", 1);
        intent.putExtra("type_name", "雄博士");
    ...
    @Override
    public void moreDate(List<SoulcoursesBean> mList) {
