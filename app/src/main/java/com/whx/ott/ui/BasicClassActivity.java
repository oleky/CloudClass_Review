 ...
 */
public class BasicClassActivity extends Activity implements View.OnFocusChangeListener
    ...
    BasicClassPresenter mClassPresenter;
...
//初始化显示
    ...
    private void initRecycler() {
        ...
        LinearLayoutManagerTV linearLayoutManager1 = new LinearLayoutManagerTV(BasicClassActivity.this);
        LinearLayoutManagerTV linearLayoutManager2 = new LinearLayoutManagerTV(BasicClassActivity.this);
        LinearLayoutManagerTV linearLayoutManager3 = new LinearLayoutManagerTV(BasicClassActivity.this);
        LinearLayoutManagerTV linearLayoutManager4 = new LinearLayoutManagerTV(BasicClassActivity.this);
        LinearLayoutManagerTV linearLayoutManager5 = new LinearLayoutManagerTV(BasicClassActivity.this);
        GridLayoutManagerTV gridLayoutManager = new GridLayoutManagerTV(BasicClassActivity.this, 2);
...
//        mRecyclerViewBridge.setFocusView(v, oldView, 1.05f);
    ...
    private void updateGridView() {
        ...
        resultAdapter = new SearchResultAdapter(BasicClassActivity.this);
        ...
        results_gp.setOnItemClickListener(new RecyclerViewTV.OnItemClickListener() {
            ...
            public void onItemClick(RecyclerViewTV parent, View itemView, int position) {
                ...
                if (TextUtils.isEmpty(file_name)) {
                    Toast.makeText(BasicClassActivity.this, "资源不存在", Toast.LENGTH_SHORT).show();
                } else {
    ...
    public void geturl(String url) {
        Intent intent = new Intent(BasicClassActivity.this, CCPlayerActivity.class);
