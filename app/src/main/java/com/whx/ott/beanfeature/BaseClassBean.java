...
public class BaseClassBean implements Serializable {
    private String id; //: ; //2; //,
    ...
    private String course_id; //: ; //2; //,
    private String course_name; //: ; //语文第2课; //,
    private String code_num; //: null,
    private String create_time; //: ; //2017-11-29 14:32:04; //
